    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("-----------------------------------------");
						System.out.println("--> 1.)BENGALURU    | INR1500 |   "+available[1]+"  <--");
    					System.out.println("--> 2.)NEW DELHI    | INR1800 |   "+available[2]+"  <--");
    					System.out.println("--> 3.)CHENNAI      | INR1350 |   "+available[3]+"  <--");
    					System.out.println("--> 4.)KOLKATA      | INR1900 |   "+available[4]+"  <--");
    					System.out.println("--> 5.)HYDERABAD    | INR1250 |   "+available[5]+"  <--");
    					System.out.println("-----------------------------------------");
						System.out.println("-----------------------------------------\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					String dest[] = { " ", "BENGALURU", "NEW DELHI", "CHENNAI", "KOLKATA", "HYDERABAD"};
    					double fare[] = { 0,1500,1800,1350,1900,1250};
    					...
    					if(print==1){
    						...
    						System.out.println("---------------------------------------\n");
    						ticketS[z][2]="0";
    						double discount=(ticketD[z][0]-(ticketD[z][0]*0.2))*ticketI[z][1];  //calculating discounts
